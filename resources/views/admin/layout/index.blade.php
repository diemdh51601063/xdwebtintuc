...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-info-sign"></i> Error</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-list"></i> <span>Nhóm tin</span> <span class="label label-important">3</span></a>
      <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-list"></i> <span>Loại tin</span> <span class="label label-important">3</span></a>
      <ul>
        <li><a href="form-common.html">Basic Form</a></li>
        <li><a href="form-validation.html">Form with Validation</a></li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-list"></i> <span>Tin</span> <span class="label label-important">3</span></a>
      <ul>
        <li><a href="form-common.html">Basic Form</a></li>
        <li><a href="form-validation.html">Form with Validation</a></li>
